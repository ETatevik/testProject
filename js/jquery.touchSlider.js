	...
	var touchSlider = {
		...
		init: function() {
			...
			if(this.opts.controls) {
				this._controls.append('<button type="button" class="ts-prev"><img src="img/caroulse-arrow-next.svg" alt=""></button><button type="button" class="ts-next"><img src="img/caroulse-arrow-next.svg" alt=""></button>');
				this._tg.before(this._controls);
